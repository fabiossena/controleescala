		...
		<div class="form-group col-12 col-xm-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 border-bottom row" style="padding:0 0 10px 0; margin: 25px 10px 20px 15px">
		  ...
		  <div class="form-group row col-12 col-xm-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
		      <label for="chk-dias-horas-trabalho-customizado" class='control-label container row'> 
		   	    ...
		   	    <span class="col-10 col-xm-10 col-sm-10 col-md-10 col-lg-10 col-xl-10" >Indicar dias e horários de trabalho customizados</span>
		      </label>
		  </div>  
				...
				<table id="tabela-dias-trabalho" class="display tabela-simples">
			       ...
			       <thead>
			        ...
			        <tbody>    
			            ...
			            <tr>
							<td	style="font-weight: bold">Terça<form:hidden id="terca-diaSemana" path="diasHorasTrabalho[1].diaSemana" /><form:hidden id="terca-id" path="diasHorasTrabalho[1].id" /></td>
							<td>
			            ...
			            <tr>
							<td	style="font-weight: bold">Sábado<form:hidden id="sabado-diaSemana" path="diasHorasTrabalho[5].diaSemana" /><form:hidden id="sabado-id" path="diasHorasTrabalho[5].id" /></td>
							<td>
