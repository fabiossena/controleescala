									  ...
									  <c:if test="${aprovacaoHora.dadosAcessoAprovacaoHoras.dadosAprovacao.size() > 0}"><b>Etapa 2:</b><br> </c:if>
									   ...
									   <div class="form-group col-sm-12">	
				        	  			...
				        	  			<c:if test="${usuarioLogado.id == aprovacaoHora.prestador.id && atendentePodeAprovar}">					          
						        	  		<div class="form-group col-sm-12">	
						        	  			<form method="POST" action="<c:url value='../upload/${aprovacaoHora.id}'/>" enctype="multipart/form-data" onsubmit="anexarClique()">
						        	  				<c:if test="${aprovacaoHora.arquivoNota!=null && aprovacaoHora.arquivoNota!=''}">
												    ...
												    <input class="btn btn-sm btn-primary" type="submit" value="Salvar nota anexa" />						        	  				
