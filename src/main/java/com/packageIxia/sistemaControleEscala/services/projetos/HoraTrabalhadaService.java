...
//		}
		...
		List<HoraTrabalhada> datas = horaTrabalhada.getHoraAprovacao().getHorasTrabalhadas(); // horaTrabalhadaAnterior.getHoraAprovacao().getHorasTrabalhadas(); // horaTrabalhadaDao.findAllByHoraAprovacaoId(horaTrabalhada.getHoraAprovacao().getId());
		if (datas != null) {
