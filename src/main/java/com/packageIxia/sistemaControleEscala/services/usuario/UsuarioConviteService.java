...
import com.packageIxia.sistemaControleEscala.services.EnvioEmail;
...
public class UsuarioConviteService implements IUsuarioConvite {
	...
	public String save(UsuarioEmailPrimeiroAcesso usuarioConvite) {
		...
		if (usuarioConvite.getFuncao() == null || usuarioConvite.getFuncao().getId() == 0) {
			return "Preencha o campo função";
		}

		if (usuarioConvite.getCentroCusto() == null || usuarioConvite.getCentroCusto().getId() == 0) {
			return "Preencha o campo centro de custo";
		}
